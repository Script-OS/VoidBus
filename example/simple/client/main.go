// Package main provides a simple VoidBus client for testing with debug output.
package main
...
func main() {
	...
	fmt.Println("=== Simple VoidBus Client (Debug) ===")
	...
	fmt.Printf("[5] Write returned: n=%d, err=%v\n", n, err)

	// 6. Wait and receive reply from server (with debug)
